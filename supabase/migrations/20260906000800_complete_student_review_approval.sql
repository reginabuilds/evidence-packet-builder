...
comment on column public.evidence_ai_proposal_reviews.included_in_record is
  'Student-controlled inclusion flag. Only accepted and included proposals may enter the final Evidence Record.';
comment on column public.evidence_ai_proposal_reviews.final_capability is
  'Optional student-edited capability wording; raw AI analysis remains unchanged.';
comment on column public.evidence_ai_proposal_reviews.final_explanation is
  'Optional student-edited explanation; must remain grounded in the proposal evidence.';
comment on column public.evidence_ai_proposal_reviews.final_supporting_evidence is
  'Student-selected supporting evidence retained separately from raw AI analysis.';
